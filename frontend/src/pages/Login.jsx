...
const Login = () => {
  ...
  const handleLocalLogin = async (e) => {
    ...
    try {
      ...
      setLocalLoginError(error.details || error.message || 'Usuario o contraseña incorrectos');
    } finally {
      setIsLoggingIn(false);
    }
  };
                  ...
                  {showLocalLogin ? (
                    <>
                      ...
                      <Alert color="blue" variant="light">
                        ...
                        <Text size="xs">• admin@sgd-web.local / admin123 (Administrador)</Text>
                        <Text size="xs">• operator@sgd-web.local / operator123 (Operador)</Text>
                        <Text size="xs">• viewer@sgd-web.local / viewer123 (Visualizador)</Text>
                      </Alert>
                    </>
                  ) : (
                    <>
